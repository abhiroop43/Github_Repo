...
<script language="c#" runat="server">
	...
	private void Page_Load(object sender, System.EventArgs e) {
		...
		if (!Page.IsPostBack) {
            ...
            if (Request.QueryString["Action"] != null)
            {
                ...
                {
                    //SqlCommand oComm = new SqlCommand("DELETE FROM GCAA_ESS_Leave_Attachments_Transport Where  DOC_ID = " + Request.QueryString["FILEID"], oConn);
                    SqlCommand oComm = new SqlCommand("UPDATE GCAA_ESS_Leave_Attachments_Transport SET REQUESTID = '*' + REQUESTID Where  DOC_ID = " + Request.QueryString["FILEID"], oConn);
                    oConn.Open();
            ...
            BindDataGrid(oConn, AttachedFiles, "SELECT DOC_ID AS FILE_ID, FILENAME AS FILE_NAME, DATALENGTH(DOCUMENT) AS FILE_SIZE, REQUESTID as [Request Id] FROM GCAA_ESS_Leave_Attachments_Transport FILES Where REQUESTID = '" + Request.QueryString["ID"] + "'");
	...
	private void btnUpload_Click(object sender, System.EventArgs e) {
		...
		if (filUpload.PostedFile != null) {
            ...
            //SqlConnection oConn = new SqlConnection("Data Source=AUHMDGPDBP01\\AUHMDGPDBP01;Initial Catalog=gcaaapps;User Id=sa;Password=Pass@gcaa!@#;");
            SqlConnection oConn = new SqlConnection(ConfigurationManager.ConnectionStrings["FMSConnString"].ConnectionString);
            SqlDataAdapter oDA = new SqlDataAdapter("SELECT DOC_ID AS FILE_ID, FILENAME AS FILE_NAME, DOCUMENT as FILE_DATA, REQUESTID as REQUESTID  FROM GCAA_ESS_Leave_Attachments_Transport FILES Where REQUESTID = '" + Request.QueryString["ID"] + "'", oConn);
	...
	private void btnDownload_Click(object sender, System.EventArgs e) {
        ...
        SqlConnection oConn = new SqlConnection(ConfigurationManager.ConnectionStrings["FMSConnString"].ConnectionString);
			...
			oConn.Open();
            SqlCommand Comm = new SqlCommand("SELECT FILENAME AS FILE_NAME, DOCUMENT FILE_DATA, DATALENGTH(DOCUMENT) AS FILE_SIZE, REQUESTID as [Request Id] FROM GCAA_ESS_Leave_Attachments_Transport as FILES Where REQUESTID = '" + Request.QueryString["ID"] + "'", oConn);//where DOC_ID IN (" + strIDs.Substring(0, strIDs.Length - 1) + ")", oConn);
...
<html>
	<head>
		<title>Transport Request - Attachment(s)</title>
			...
			<table width="600px">
			  <tr> 
			    <td align="center" class="" colspan="2" visible="false"
                    ...
                    Attachment(s) for Transport Request </td>
			  </tr>
